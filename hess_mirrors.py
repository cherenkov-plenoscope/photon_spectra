...
@article{gaug2019using,
  ...
  author={Gaug, Markus and Fegan, Steven and Mitchell, AMW and Maccarone, Maria-Concetta and Mineo, Teresa and Okumura, Akira},
...
degradation_factor = 0.71

hess_ct5_mirror_degraded = hess_ct5_mirror.copy()
hess_ct5_mirror_degraded[:, 1] *= degradation_factor
